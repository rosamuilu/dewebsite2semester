...
'''
Author: Rosa Muilu
Known bugs: I can't make text wrapping to work :(
'''
...
surveillancedata = surveillancedata.replace({'Type of Juris': {'University ': 'University'}})
...
#pio.write_html(graphNY, file="index.html", auto_open=True)
#pio.write_html(graphLA, file="index.html", auto_open=True)
#pio.write_html(graphCHI, file="index.html", auto_open=True)
#pio.write_html(graphHTX, file="index.html", auto_open=True)